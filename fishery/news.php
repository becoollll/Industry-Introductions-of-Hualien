<html>
    <head>
        <title>相關新聞、文章</title>
        <link rel="stylesheet" type="text/css" href="../CSS/fishery/news.css">
    </head>
    ...
    <script>
        fetch('https://newsapi.org/v2/everything?q=花蓮漁業&sortBy=publishedAt&apiKey=3d6df53d194f4017944177c522ea5137') // 替換為你的API端點
